//
// Created by Eli Baumgardner on 10/5/25.
//

#ifndef SEQUENCETREE_PLUGINMODULES_H
#define SEQUENCETREE_PLUGINMODULES_H

#include <juce_gui_basics/juce_gui_basics.h>               // For Component, Graphics, MouseEvent, DocumentWindow, etc.
