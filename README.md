...
An audio plugin (AU / VST3 / Standalone) that generates MIDI by traversing a user-designed directed graph.
...
`JUCE_COPY_PLUGIN_AFTER_BUILD` is on, so a successful build installs the plugin to the system AU/VST3/Standalone locations automatically.
